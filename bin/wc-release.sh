...
#
#   bin/wc-release.sh                 deploy HEAD
#   bin/wc-release.sh <ref>           deploy any ref
#   bin/wc-release.sh --list          what is deployed, and what is current
#   bin/wc-release.sh --rollback      point `current` at the previous release
#   bin/wc-release.sh --dry-run       stage and verify, change nothing live
set -uo pipefail
