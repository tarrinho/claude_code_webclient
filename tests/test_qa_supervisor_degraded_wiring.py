"""QA: every DB write in supervisor.py that can silently fail marks the run
degraded, and every one that can silently start working again clears it.

See docs/superpowers/specs/2026-09-04-supervisor-observability-design.md's
...
class CallSiteTests(unittest.TestCase):
    ...
    looks exactly like a supervisor that happened not to hit that failure."""
