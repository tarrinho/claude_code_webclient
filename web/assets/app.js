...
import {createChatListController} from './chat-list.js?v=7161683';
...
async function _switchTab(tab) {
  ...
  if (tab === 'delegation') {
    const {loadDelegation} = await import('./delegation.js?v=delegation_pin_20260920');
    loadDelegation(true);
  }
}
...
import { startServerPolling, stopServerPolling, loadServer, notifyResult, setStatus } from './server-stats.js?v=5802461';
...
import { loadTransports, _transports, _showAddTransport, _cancelTransportForm, _testTransportForm, _saveTransport } from './transports.js?v=6434176';
